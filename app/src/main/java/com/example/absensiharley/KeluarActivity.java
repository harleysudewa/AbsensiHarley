...
public class KeluarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAbsen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                db = new DatabaseHelper(KeluarActivity.this);
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(date) || TextUtils.isEmpty(location) || TextUtils.isEmpty(time))  {
                    Toast.makeText(KeluarActivity.this, "Semua field harus diisi.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (checkInsertData == true) {
                    Toast.makeText(KeluarActivity.this, "Data absensi berhasil disimpan!", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(KeluarActivity.this, MainActivity.class));
                } else {
                    Toast.makeText(KeluarActivity.this, "Gagal menyimpan data absensi.", Toast.LENGTH_SHORT).show();
                }
            }
        });

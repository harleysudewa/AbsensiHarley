...
public class IzinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAbsen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                db = new DatabaseHelper(IzinActivity.this);
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(date) || TextUtils.isEmpty(location) || TextUtils.isEmpty(time))  {
                    Toast.makeText(IzinActivity.this, "Semua field harus diisi.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (checkInsertData == true) {
                    Toast.makeText(IzinActivity.this, "Data absensi berhasil disimpan!", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(IzinActivity.this, MainActivity.class));
                } else {
                    Toast.makeText(IzinActivity.this, "Gagal menyimpan data absensi.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setDateEditText() {
        editTextTanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(IzinActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
